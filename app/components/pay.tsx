...
import { TransactionOutlined, AlipayOutlined, WechatOutlined } from '@ant-design/icons';
    ...
    <div className={styles["pay-mask"]}>
      <div className={styles["pay-wrapper"]}>
            ...
            {item.goods.map(good => (
              <>
                <div className={styles["pay-goods-wrapper"]} key={good.id}>
                  ...
                  <Radio checked={radioValue===1} value={1} onChange={onChange}>A</Radio>
                  </div>
                </div>
                <div className={styles["pay-good-desc"]}>{good.gd_description}</div>
              </>
            ))}
          </div>
        ))}
        ...
        <div className={styles["pay-bottom"]}>
          <Button  className={styles["pay-btn"]} onClick={payConfirm}>确定支付</Button>
        </div>
      </div>
